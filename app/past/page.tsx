            ...
            <main className="flex flex-col bg-white h-full w-full pt-20 gap-8 md:gap-16 justify-between items-center">
              ...
              ul.nextSibling.setAttribute('aria-hidden', 'true');
                ...
                >
                    ...
                    >
                        <li>
                            <img src="/landing-page/assets/pics/1.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/2.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/3.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/4.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/5.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/6.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/7.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/8.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/9.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/10.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/11.JPG" className="rounded-xl h-72" />
                        </li>
                        <li>
                            <img src="/landing-page/assets/pics/12.JPG" className="rounded-xl h-72" />
                        </li>
                    </ul>
                </section>
                <section className="flex flex-col items-center w-full px-24 md:px-60 lg:px-72 relative">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-[repeat(auto-fit,_25%)] items-center justify-center justify-items-center gap-6 md:gap-8 place-items-center">
                        ...
                        <a
                            ...
                            target="_blank"
                        >
                            <img src="/landing-page/assets/sponsors/ford.png" alt="Ford" className="mx-auto" />
                        </a>
