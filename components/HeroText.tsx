...
export default function HeroText({ showButton = true }: HeroTextProps) {
    return (
        <div className="container mx-auto text-white">
            ...
            {showButton && <ApplyButton text="Apply Now!" link='https://boilermake-apply.web.app' size="small" className="sm:hidden"  />}
            {showButton && <ApplyButton text="Apply Now!" link='https://boilermake-apply.web.app' size="medium" className="hidden sm:block lg:hidden" />}
            {showButton && <ApplyButton text="Apply Now!" link='https://boilermake-apply.web.app' size="large" className="hidden lg:block" />}
        </div>
    );
}
