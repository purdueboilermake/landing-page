...
export default function EventPopup({ title, date, location, description }: EventPopupProps) {
    ...
    return (
        <div className="bg-[#E4F0F3] p-3 md:p-6 rounded-lg shadow-lg w-[280px] md:w-[350px] lg:w-[400px] space-y-2 text-left cursor-default whitespace-normal break-words">
            {/* Title Section */}
