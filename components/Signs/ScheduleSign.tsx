        ...
        <div className="w-full h-full">
            <div className="relative w-full h-auto flex items-center justify-center">
                ...
                <div className='absolute z-10 flex flex-col items-center justify-center'>
                    ...
                    <a href="/schedule.pdf" target="_blank" rel="noopener noreferrer" className="text-center text-[#06A77D] text-sm md:text-md lg:text-xl mt-16 pt-0 md:pt-6 font-semibold">click for more!</a>
                </div>
            </div>
        </div>
    );
